			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="email" name="email" value="" placeholder="Enter ur email" required="" class="form-control"/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="comment" name="comment" placeholder="Enter detail Description" required="" value="" class="form-control"/>
					</div>
				</div>
			</div>
			<div class="row">
