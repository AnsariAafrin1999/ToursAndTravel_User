	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	<li style="background-image: url(images/images1.jpg);">
		...
		<h2>Book your Trip</h2>
			...
			<div class="col-md-6">
				<div class="form-group">
 				...
 				<input type="text" name="name" value="" placeholder="Enter ur name" required="" class="form-control"/>	
 				</div>				
			</div>
		</div>
		<div class="row">
 					<div class="col-12">
 						...
 						<select name="user_id">
 							<option value="1">Ritu kumar</option>
 							<option value="2">Amit bhai</option>
 							<option value="1">krishna</option>
 							<option value="1">anisha</option>
 						</select>
 						</div>
 					</div>
 				</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="Description" name="Description" placeholder="Enter detail Description" required="" value="" class="form-control"/>
					</div>
				</div>
			</div>
		<div class="row">
