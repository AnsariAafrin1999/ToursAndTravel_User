			...
			<div class="row">
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="colorlib-contact-info">
						<h3>Contact Us</h3>
						<ul>
							<li class="address">Opp,Hanuman Temple, <br> Bapunagar,Ahmedabad.</li>
							<li class="phone"><a href="tel://1234567920">(+91)9099981373</a></li>
							<li class="email"><a href="www.adtoursandtravel.com">www.adtoursandtravel.com</a></li>
				...
				<div class="col-md-6 animate-box">
					...
					<input type="text" name="Feedback" placeholder="Enter ur Feedback" required="" class="form-control" />		
				</div>
