...
<head>
	...
	<div id="page">
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	...
			   	<li style="background-image: url(images/singapur.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
		...
		<div class="colorlib-tour colorlib-light-grey">
			...
			<div class="tour-wrap">
				@foreach($design as $d)
				<a href="{{route('getpackage',['id'=>$d->id])}}" class="tour-entry animate-box">
					<div class="tour-img" style="background-image: url({{env('ADMIN_URL').'upload/'.$d->pack_image}});"></div>
						<span class="desc">
						<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span></p>
						<h2>{{$d->pack_name}}</h2>
						<h2>{{$d->pack_price}}</h2>
						<!-- <h2><a href="{{route('getpackage',['id'=>$d->id])}}">Book</a></h2> -->
						...
						<div class="f-tour">
							<div class="row row-pb-md">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/himanchal/manali.jpg);">
												<div class="desc">
													<h3>Manali</h3>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/himanchal/Shimla1.jpg);">
												<div class="desc">
													<h3>Shimla</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/himanchal/Kullu.jpg);">
												<div class="desc">
													<h3>Kullu</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/himanchal/dharamshala.jpg);">
												<div class="desc">
													<h3>dharamshala</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
						...
						<div class="f-tour">
							<div class="row">
								<div class="col-md-6 col-md-push-6">
									<div class="row">
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/rajshthan/jodhpur.jpg);">
												<div class="desc">
													<h3>jodhpur</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/rajshthan/mountabu.jpg);">
												<div class="desc">
													<h3>mountabu</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/rajshthan/udaipur.jpg);">
												<div class="desc">
													<h3>udaipur</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/rajshthan/bundi.jpg);">
												<div class="desc">
													<h3>bundi</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
						...
						<div class="f-tour">
							<div class="row row-pb-md">
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/dubai2.jpg);">
												<div class="desc">
													<h3>Rome</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/italy1.jpg);">
												<div class="desc">
													<h3>Rome</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/singapur2.jpg);">
												<div class="desc">
													<h3>Rome</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
										...
										<div class="col-md-6 animate-box">
											<a  href="" class="f-tour-img" style="background-image: url(images/thailand1.jpg);">
												<div class="desc">
													<h3>Rome</h3>
													<p class="price"><span></span> <small></small></p>
												</div>
